...
<body>
        ...
        <?php while ($row = mysqli_fetch_array($query)): ?>
            <div class="card" style="width: 18rem;">
                <div class="card-body">
                   ...
                   <a href="updateForm/update.php?idAlumnos=<?= $row['idAlumnos'] ?>" class="btn btn-warning">Editar</a><a href="CRUD/delete_project.php?idAlumnos=<?= $row['idAlumnos'] ?>" class="btn btn-danger">Borrar</a>
                </div>
            </div>
        <?php endwhile; ?>
    </div>
    ...
    <div class="container mt-5">
        ...
        <form action="CRUD/insert_project.php" method="POST">
            ...
            <div class="form-group">
                <label for="technologies">Edad</label>
